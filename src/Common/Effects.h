...
namespace Graphics {
    ...
    public:
        ...
        MeshDataInput GetInputData(const Graphics::MeshData& meshData) override;
    ...
    class BoudingBoxEffect : public IEffect, public IEffectTransform,
        IEffectMeshData
    {
    public:
        BoudingBoxEffect();
        virtual ~BoudingBoxEffect() override;

        BoudingBoxEffect(BoudingBoxEffect&& moveFrom) noexcept;
        BoudingBoxEffect& operator=(BoudingBoxEffect&& moveFrom) noexcept;

        // 获取单例
        static BoudingBoxEffect& Get();
        ...
        MeshDataInput GetInputData(const MeshData& meshData);
